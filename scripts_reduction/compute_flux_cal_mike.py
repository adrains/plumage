...
calspec_rvs = {
    "5709390701922940416":206, #178,  # 206                 # RV offset !!!
    "3510294882898890880":155, #133,  # 155                 # RV offset !!!
    "22745910577134848":12, #10,     # 12
    "4201781696994073472":0,    # Not in calspec                  # WD
    "5164707970261890560":-82,  # Not in calspec
    "4376174445988280576":398, #-442, #-398                # RV offset !!!
    "5957698605530828032":100, #80,   # 100
    "6342346358822630400":-19, #-79,  # -19                # RV offset ?
    "6477295296414847232":-45, #-85,  # -45
    "1779546757669063552":-15, #-72,  # -15
}

# Initial guess scale terms
flux_standard_tau_scale_terms = {         # O2, H2O
    ("6477295296414847232", "2025-07-02"):(0.95, 0.85),
    ("22745910577134848",   "2021-11-22"):(1.05, 0.5),
    ("4376174445988280576", "2025-07-02"):(1.0, 0.75),
    ("6342346358822630400", "2025-07-02"):(1.35, 1.05),   # resolution issue?
    ("4201781696994073472", "2025-07-02"):(0.95, 0.85),
    ("1779546757669063552", "2025-07-02"):(1.15, 0.9),   # resolution issue?
    ("5164707970261890560", "2025-07-02"):(1.3, 1.05),   # resolution issue?
    ("5957698605530828032", "2025-07-02"):(0.9, 0.7),
    ("3510294882898890880", "2025-05-19"):(0.9, 0.9),
    ("3510294882898890880", "2025-05-20"):(0.9, 0.65),
    ("5709390701922940416", "2025-05-19"):(1.1, 1.05),   # resolution issue?
    ("6477295296414847232", "2025-08-28"):(0.95, 0.4),
