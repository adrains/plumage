...
// The Stannon: a seven-label, second-order model implementation of the Cannon.
...
data {
    ...
    matrix[S, 36] DM; // design matrix
}


parameters {
    matrix[1, 36] theta; // the theta coefficients / spectral derivatives
