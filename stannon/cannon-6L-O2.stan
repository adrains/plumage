...
// The Stannon: a six-label, second-order model implementation of the Cannon.
...
data {
    ...
    matrix[S, 28] DM; // design matrix
}


parameters {
    matrix[1, 28] theta; // the theta coefficients / spectral derivatives
