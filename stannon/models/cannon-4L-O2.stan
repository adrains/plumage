...
// The Stannon: a four-label, second-order model implementation of the Cannon.
...
data {
    ...
    matrix[S, 15] DM; // design matrix
}


parameters {
    matrix[1, 15] theta; // the theta coefficients / spectral derivatives
