...
// The Stannon: an eight-label, second-order model implementation of the Cannon.
...
data {
    ...
    matrix[S, 45] DM; // design matrix
}


parameters {
    matrix[1, 45] theta; // the theta coefficients / spectral derivatives
