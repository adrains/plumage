...
// The Stannon: a five-label, second-order model implementation of the Cannon.
...
data {
    ...
    matrix[S, 21] DM; // design matrix
}


parameters {
    matrix[1, 21] theta; // the theta coefficients / spectral derivatives
